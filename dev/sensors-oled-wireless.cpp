...
constexpr const char* SSID = "David";
constexpr const char* PASSWORD = "DaveRLing20*"; 
constexpr uint32_t CHANNEL_ID = 2739691;
constexpr const char* WRITE_API_KEY = "0ID5AEJYJJ82E9JB";
